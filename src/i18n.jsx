...
const en = {
  ...
  'live.reads.desc': 'Build stat-backed profiles on every player you face. Know their aggression and tendencies before you act.',
...
const pl = {
  ...
  'live.reads.desc': 'Buduj profile oparte na statystykach dla każdego gracza. Poznaj ich agresję i tendencje zanim zaczniesz działać.',
...
const ru = {
  ...
  'live.reads.desc': 'Строй профили с реальной статистикой на каждого соперника. Знай их агрессию и склонности заранее.',
...
const fr = {
  ...
  'live.reads.desc': 'Construis des profils fondés sur les stats de chaque joueur. Connais leur agressivité et leurs tendances avant de jouer.',
...
const es = {
  ...
  'live.reads.desc': 'Construye perfiles basados en stats de cada jugador. Conoce su agresión y tendencias antes de actuar.',
...
const de = {
  ...
  'live.reads.desc': 'Baue stat-basierte Profile über jeden Gegner. Kenne ihre Aggression und Tendenzen, bevor du handelst.',
...
const pt = {
  ...
  'live.reads.desc': 'Construa perfis baseados em stats de cada jogador. Saiba a agressão e as tendências antes de agir.',
...
const tr = {
  ...
  'live.reads.desc': 'Her rakibin için istatistik tabanlı profiller oluştur. Hamlenden önce agresyonunu ve eğilimlerini bil.',
...
const uk = {
  ...
  'live.reads.desc': 'Будуйте профілі на основі статистики для кожного гравця, з яким граєте. Знайте їхню агресію та схильності, перш ніж діяти.',
...
const ro = {
  ...
  'live.reads.desc': 'Construiește profiluri bazate pe statistici pentru fiecare jucător pe care îl întâlnești. Află agresivitatea și tendințele lor înainte să acționezi.',
...
const sk = {
  ...
  'live.reads.desc': 'Vytvárajte štatisticky podložené profily každého hráča, proti ktorému hráte. Poznajte jeho agresivitu a tendencie ešte pred svojím ťahom.',
