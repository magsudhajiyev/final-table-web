...
const en = {
  ...
  'hiw.body': "Review opponent profiles and past hand history before you sit down. Read the vibe so you adjust to your table. Know who is tight, who's wild and where the money is.",
  'hiw.handlog.title': ['Set up your table.', 'Start logging.'],
  ...
  'hiw.stats.title': ['Plan your next step,', 'knowing your stats.'],
  'hiw.stats.body': 'See your live stats update after every hand: PFR, aggression and more. Spot your leaks and your opponents\' tendencies in the moment, so every decision is backed by real numbers, not gut feel.',
  ...
  'compare.card2.desc': 'Build stat-backed profiles on every player you face. Know their aggression and tendencies before you act.',
  ...
  'buckle.ranges.title': 'Ranges',
  'buckle.ranges.desc': 'Build and study hand ranges for every spot. Visualise the hands you play, compare your decisions to solver-approved ranges, and tighten up the leaks in your game.',
  ...
  'live.reads.desc': 'Build stat-backed profiles on every player you face. Review their aggression and tendencies before you sit down, so you walk in prepared.',
  ...
  'blogTeaser.eyebrow': 'From the blog',
  'blogTeaser.title': 'Stories, strategy, and product notes.',
  'blogTeaser.viewAll': 'View all posts',
  'blogTeaser.read': 'Read',
  'blogTeaser.minRead': (p) => `${p.n} min read`,
  'blogTeaser.tag.strategy': 'Strategy',
  'blogTeaser.tag.product': 'Product',
  'blogTeaser.tag.news': 'News',
  ...
  'discord.msg3.text': 'Post your best hand of the week in #hands and we break them down together 🃏',
  ...
  'problems.3.body': 'Final Table builds opponent profiles from logged hands, with real stats and real tendencies, so your reads are backed by data, not memory.',
  ...
  'community.msg3.text': 'Post your best hand of the week in #hands and we break them down together 🃏',
}
...
const pl = {
  ...
  'hiw.body': 'Przeglądaj profile przeciwników i historię rozdań, zanim usiądziesz do gry. Wyczuj klimat stołu, żeby się do niego dostosować. Zobacz, kto gra ciasno, kto szaleje i gdzie są pieniądze.',
  'hiw.handlog.title': ['Ustaw swój stół.', 'Zacznij zapisywać.'],
  'hiw.handlog.body': 'Rejestruj akcję na bieżąco (raise, call, fold) przesunięciem i dotknięciem. Bez pisania, bez menu. Każde rozdanie zapisane do późniejszej analizy.',
  'hiw.stats.label': 'Przy stole',
  'hiw.stats.title': ['Zaplanuj następny ruch,', 'znając swoje statystyki.'],
  'hiw.stats.body': 'Obserwuj, jak Twoje statystyki na żywo aktualizują się po każdym rozdaniu: PFR, agresja i więcej. Wychwytuj swoje słabości i tendencje przeciwników na bieżąco, aby każda decyzja opierała się na prawdziwych liczbach, a nie na przeczuciu.',
  ...
  'compare.card2.desc': 'Buduj profile statystyczne każdego gracza. Znaj ich agresję i tendencje, zanim zagrasz.',
  ...
  'buckle.ranges.title': 'Ranges',
  'buckle.ranges.desc': 'Buduj i analizuj ranges rąk dla każdej sytuacji. Zobacz, jakie ręce grasz, porównaj swoje decyzje z ranges zatwierdzonymi przez solver i wyeliminuj leaki w swojej grze.',
  ...
  'live.reads.desc': 'Buduj profile oparte na statystykach dla każdego gracza, z którym grasz. Przeanalizuj ich agresję i tendencje, zanim usiądziesz do stołu, aby zasiąść przygotowanym.',
  ...
  'blogTeaser.eyebrow': 'Z bloga',
  'blogTeaser.title': 'Historie, strategia i notki o produkcie.',
  'blogTeaser.viewAll': 'Zobacz wszystkie wpisy',
  'blogTeaser.read': 'Czytaj',
  'blogTeaser.minRead': (p) => `${p.n} min czytania`,
  'blogTeaser.tag.strategy': 'Strategia',
  'blogTeaser.tag.product': 'Produkt',
  'blogTeaser.tag.news': 'Aktualności',
  ...
  'problems.2.body': 'Final Table rozbija Twoje wyniki według pozycji, więc widzisz, gdzie zarabiasz i gdzie tracisz żetony.',
  ...
  'problems.3.body': 'Final Table buduje profile przeciwników z zalogowanych rozdań (prawdziwe statystyki, prawdziwe tendencje), więc Twoje odczyty oparte na danych, nie pamięci.',
...
const ru = {
  ...
  'hiw.body': 'Смотри профили соперников и историю раздач до того, как сядешь за стол. Прочувствуй атмосферу стола, чтобы под него подстроиться. Знай, кто играет плотно, кто дико и где деньги.',
  'hiw.handlog.title': ['Настрой свой стол.', 'Начни запись.'],
  'hiw.handlog.body': 'Фиксируй действия по ходу игры (raise, call, fold) свайпом и касанием. Без набора текста, без меню. Каждая раздача сохранена для последующего разбора.',
  'hiw.stats.label': 'За столом',
  'hiw.stats.title': ['Планируй следующий шаг,', 'зная свою статистику.'],
  'hiw.stats.body': 'Смотри, как твоя статистика обновляется вживую после каждой раздачи: PFR, агрессия и не только. Замечай свои утечки и наклонности оппонентов прямо в моменте, чтобы каждое решение опиралось на реальные цифры, а не на интуицию.',
  ...
  'compare.subtitle': 'Покерные трекеры существуют. Ни один не чувствуется своим за столом. Final Table становится частью игры.',
  ...
  'compare.card2.desc': 'Создавайте статистические профили каждого игрока. Знайте их агрессию и тенденции до того, как действовать.',
  ...
  'buckle.subtitle': 'Логирование раздач: лишь вершина айсберга. У Final Table много других умных функций.',
  'buckle.ranges.title': 'Ranges',
  'buckle.ranges.desc': 'Составляй и изучай ranges рук для любой ситуации. Визуализируй, какие руки ты играешь, сравнивай свои решения с ranges, одобренными солвером, и устраняй лики в своей игре.',
  ...
  'live.reads.desc': 'Строй профили с реальной статистикой на каждого соперника. Изучай их агрессию и склонности до того, как сядешь за стол, чтобы прийти подготовленным.',
  ...
  'blogTeaser.eyebrow': 'Из блога',
  'blogTeaser.title': 'Истории, стратегия и заметки о продукте.',
  'blogTeaser.viewAll': 'Все статьи',
  'blogTeaser.read': 'Читать',
  'blogTeaser.minRead': (p) => `${p.n} мин чтения`,
  'blogTeaser.tag.strategy': 'Стратегия',
  'blogTeaser.tag.product': 'Продукт',
  'blogTeaser.tag.news': 'Новости',
  ...
  'problems.2.stat': 'Позиция даёт самое большое преимущество в покере.',
  ...
  'features.subtitle': 'Логирование рук: лишь верхушка айсберга. У Final Table есть множество других интеллектуальных функций.',
  ...
  'cta.body': 'Закрепи свой постоянный ник до запуска. Ники достаются по принципу «кто первый, тот и забрал». Как уйдёт, уйдёт.',
  ...
  'about.missionP5': 'Final Table создан для каждого живого игрока, который хоть раз заканчивал сессию, зная что сыграл что-то неправильно, но не мог вспомнить что. Каждая рука рассказывает историю. Мы просто помогаем вам её не потерять.',
...
const fr = {
  ...
  'hiw.body': "Consulte les profils des adversaires et l'historique des mains avant même de t'asseoir. Ressens l'ambiance pour t'adapter à ta table. Sache qui est serré, qui est fou et où se trouve l'argent.",
  'hiw.handlog.title': ['Installe ta table.', 'Lance la saisie.'],
  'hiw.handlog.body': "Capture l'action en direct (raise, call, fold) d'un glissement et d'une pression. Sans saisie, sans menus. Chaque main enregistrée pour l'analyser plus tard.",
  'hiw.stats.label': 'À la table',
  'hiw.stats.title': ['Planifie ton prochain coup,', 'en connaissant tes stats.'],
  'hiw.stats.body': "Vois tes stats se mettre à jour en direct après chaque main: PFR, agressivité et bien plus. Repère tes fuites et les tendances de tes adversaires sur le moment, pour que chaque décision repose sur de vrais chiffres, pas sur l'instinct.",
  ...
  'compare.card2.desc': 'Construisez des profils statistiques de chaque joueur. Connaissez leur agressivité et leurs tendances avant d\'agir.',
  ...
  'buckle.ranges.title': 'Ranges',
  'buckle.ranges.desc': "Construis et étudie des ranges de mains pour chaque situation. Visualise les mains que tu joues, compare tes décisions aux ranges approuvées par le solver et corrige les leaks de ton jeu.",
  ...
  'live.reads.desc': "Construis des profils fondés sur les stats de chaque joueur que tu affrontes. Étudie leur agressivité et leurs tendances avant de t'asseoir, pour arriver préparé.",
  ...
  'footer.contactHead': 'Contact',
  'blogTeaser.eyebrow': 'Sur le blog',
  'blogTeaser.title': 'Récits, stratégie et notes produit.',
  'blogTeaser.viewAll': 'Voir tous les articles',
  'blogTeaser.read': 'Lire',
  'blogTeaser.minRead': (p) => `${p.n} min de lecture`,
  'blogTeaser.tag.strategy': 'Stratégie',
  'blogTeaser.tag.product': 'Produit',
  'blogTeaser.tag.news': 'Actus',
  ...
  'problems.3.body': 'Final Table construit des profils adverses à partir des mains enregistrées, avec de vraies stats et de vraies tendances, pour que vos lectures reposent sur les données, pas la mémoire.',
...
const es = {
  ...
  'hiw.body': 'Revisa los perfiles de los rivales y el historial de manos antes de sentarte. Capta el ambiente para adaptarte a tu mesa. Sabe quién es tight, quién es loco y dónde está el dinero.',
  'hiw.handlog.title': ['Configura tu mesa.', 'Empieza a registrar.'],
  'hiw.handlog.body': 'Captura la acción a medida que ocurre (raise, call, fold) con un deslizamiento y un toque. Sin escribir, sin menús. Cada mano guardada para revisarla después.',
  'hiw.stats.label': 'En la mesa',
  'hiw.stats.title': ['Planifica tu próxima jugada,', 'conociendo tus stats.'],
  'hiw.stats.body': 'Mira cómo tus stats se actualizan en vivo después de cada mano: PFR, agresión y más. Detecta tus fugas y las tendencias de tus rivales en el momento, para que cada decisión se base en números reales y no en la intuición.',
  ...
  'compare.card2.desc': 'Crea perfiles estadísticos de cada jugador. Conoce su agresividad y tendencias antes de actuar.',
  ...
  'buckle.ranges.title': 'Ranges',
  'buckle.ranges.desc': 'Construye y estudia ranges de manos para cada situación. Visualiza las manos que juegas, compara tus decisiones con ranges aprobadas por el solver y corrige los leaks de tu juego.',
  ...
  'live.reads.desc': 'Construye perfiles basados en stats de cada jugador al que te enfrentas. Revisa su agresión y tendencias antes de sentarte, para llegar preparado.',
  ...
  'blogTeaser.eyebrow': 'Del blog',
  'blogTeaser.title': 'Historias, estrategia y notas del producto.',
  'blogTeaser.viewAll': 'Ver todos los artículos',
  'blogTeaser.read': 'Leer',
  'blogTeaser.minRead': (p) => `${p.n} min de lectura`,
  'blogTeaser.tag.strategy': 'Estrategia',
  'blogTeaser.tag.product': 'Producto',
  'blogTeaser.tag.news': 'Noticias',
  ...
  'discord.msg1.time': '21:12',
  'discord.msg1.text': '👋 Bienvenido: las invitaciones a la beta y los previews aterrizan aquí primero.',
  ...
  'problems.3.body': 'Final Table construye perfiles de oponentes a partir de manos registradas (stats reales, tendencias reales), así tus lecturas se basan en datos, no en memoria.',
  ...
  'faq.2.a': 'Los nicks se asignan por orden de llegada. Si el tuyo está tomado, prueba una variante. Los guiones bajos y números están permitidos.',
...
const de = {
  ...
  'hiw.body': 'Sieh dir Gegnerprofile und Hand-Historie an, bevor du überhaupt Platz nimmst. Spür die Stimmung, um dich auf deinen Tisch einzustellen. Weiß, wer tight ist, wer wild spielt und wo das Geld liegt.',
  'hiw.handlog.title': ['Richte deinen Tisch ein.', 'Starte das Mitschreiben.'],
  'hiw.handlog.body': 'Erfasse die Action, während sie passiert (raise, call, fold), mit einem Wisch und einem Tipp. Kein Tippen, keine Menüs. Jede Hand für die spätere Analyse gespeichert.',
  'hiw.stats.label': 'Am Tisch',
  'hiw.stats.title': ['Plane deinen nächsten Zug,', 'mit deinen Stats im Blick.'],
  'hiw.stats.body': 'Sieh, wie sich deine Stats nach jeder Hand live aktualisieren: PFR, Aggression und mehr. Erkenne deine Leaks und die Tendenzen deiner Gegner im Moment, sodass jede Entscheidung auf echten Zahlen beruht, nicht auf Bauchgefühl.',
  ...
  'compare.card2.desc': 'Erstelle statistische Profile jedes Spielers. Kenne Aggression und Tendenzen, bevor du agierst.',
  ...
  'buckle.ranges.title': 'Ranges',
  'buckle.ranges.desc': 'Erstelle und studiere Hand-Ranges für jede Situation. Visualisiere die Hände, die du spielst, vergleiche deine Entscheidungen mit solver-geprüften Ranges und beseitige die Leaks in deinem Spiel.',
  'buckle.bankroll.title': 'Bankroll-Tracking',
  ...
  'live.reads.desc': 'Baue stat-basierte Profile über jeden Gegner, gegen den du spielst. Sieh dir ihre Aggression und Tendenzen an, bevor du dich an den Tisch setzt, damit du vorbereitet bist.',
  ...
  'footer.contactHead': 'Kontakt',
  'blogTeaser.eyebrow': 'Aus dem Blog',
  'blogTeaser.title': 'Geschichten, Strategie und Produktnotizen.',
  'blogTeaser.viewAll': 'Alle Beiträge ansehen',
  'blogTeaser.read': 'Lesen',
  'blogTeaser.minRead': (p) => `${p.n} Min. Lesezeit`,
  'blogTeaser.tag.strategy': 'Strategie',
  'blogTeaser.tag.product': 'Produkt',
  'blogTeaser.tag.news': 'News',
  ...
  'problems.3.body': 'Final Table erstellt Gegnerprofile aus erfassten Händen, mit echten Stats und echten Tendenzen, sodass deine Reads auf Daten basieren, nicht auf Erinnerung.',
...
const pt = {
  ...
  'hiw.body': 'Confira perfis dos adversários e histórico de mãos antes mesmo de sentar. Sinta o clima para se adaptar à sua mesa. Saiba quem é tight, quem é louco e onde está o dinheiro.',
  'hiw.handlog.title': ['Configure sua mesa.', 'Comece a registrar.'],
  'hiw.handlog.body': 'Capture a ação conforme ela acontece (raise, call, fold) com um deslize e um toque. Sem digitar, sem menus. Cada mão salva para revisar depois.',
  'hiw.stats.label': 'Na mesa',
  'hiw.stats.title': ['Planeje sua próxima jogada,', 'conhecendo suas stats.'],
  'hiw.stats.body': 'Veja suas stats se atualizarem ao vivo depois de cada mão: PFR, agressão e mais. Identifique seus leaks e as tendências dos oponentes no momento, para que cada decisão seja baseada em números reais, e não no instinto.',
  ...
  'compare.card2.desc': 'Crie perfis estatísticos de cada jogador. Conheça a agressividade e as tendências antes de agir.',
  ...
  'buckle.ranges.title': 'Ranges',
  'buckle.ranges.desc': 'Monte e estude ranges de mãos para cada situação. Visualize as mãos que você joga, compare suas decisões com ranges aprovadas pelo solver e corrija os leaks do seu jogo.',
  ...
  'live.reads.desc': 'Construa perfis baseados em stats de cada jogador que enfrenta. Analise a agressão e as tendências antes de sentar à mesa, para chegar preparado.',
  ...
  'blogTeaser.eyebrow': 'Do blog',
  'blogTeaser.title': 'Histórias, estratégia e notas do produto.',
  'blogTeaser.viewAll': 'Ver todos os posts',
  'blogTeaser.read': 'Ler',
  'blogTeaser.minRead': (p) => `${p.n} min de leitura`,
  'blogTeaser.tag.strategy': 'Estratégia',
  'blogTeaser.tag.product': 'Produto',
  'blogTeaser.tag.news': 'Notícias',
  ...
  'problems.3.body': 'Final Table constrói perfis de oponentes a partir de mãos registradas (stats reais, tendências reais), então suas leituras baseadas em dados, não em memória.',
...
const tr = {
  ...
  'hiw.body': 'Oturmadan önce rakip profillerini ve el geçmişini incele. Masanın havasını sez ki ona göre kendini ayarlayasın. Kim sıkı, kim vahşi, para nerede öğren.',
  'hiw.handlog.title': ['Masanı kur.', 'Kayda başla.'],
  'hiw.handlog.body': 'Aksiyonu olduğu anda yakala (raise, call, fold) bir kaydırma ve bir dokunuşla. Yazı yok, menü yok. Her el sonradan incelemek için kaydedilir.',
  'hiw.stats.label': 'Masa başında',
  'hiw.stats.title': ['Bir sonraki adımını,', 'istatistiklerini bilerek planla.'],
  'hiw.stats.body': 'İstatistiklerinin her elden sonra canlı olarak güncellenmesini izle: PFR, agresyon ve daha fazlası. Kendi açıklarını ve rakiplerinin eğilimlerini anında yakala, böylece her karar önseziye değil gerçek sayılara dayansın.',
  ...
  'compare.card2.desc': 'Karşılaştığınız her oyuncunun istatistik profilini oluşturun. Hamle yapmadan önce agresyon ve eğilimlerini bilin.',
  ...
  'buckle.ranges.title': 'Ranges',
  'buckle.ranges.desc': 'Her durum için el ranges oluştur ve çalış. Oynadığın elleri görselleştir, kararlarını solver onaylı ranges ile karşılaştır ve oyunundaki leakleri kapat.',
  ...
  'live.reads.desc': 'Karşılaştığın her oyuncu için istatistik tabanlı profiller oluştur. Masaya oturmadan önce agresyonlarını ve eğilimlerini incele, böylece hazırlıklı gelirsin.',
  ...
  'blogTeaser.eyebrow': 'Blogdan',
  'blogTeaser.title': 'Hikâyeler, strateji ve ürün notları.',
  'blogTeaser.viewAll': 'Tüm yazıları gör',
  'blogTeaser.read': 'Oku',
  'blogTeaser.minRead': (p) => `${p.n} dk okuma`,
  'blogTeaser.tag.strategy': 'Strateji',
  'blogTeaser.tag.product': 'Ürün',
  'blogTeaser.tag.news': 'Haberler',
...
const uk = {
  ...
  'hiw.body': 'Переглядайте профілі суперників та історію роздач ще до того, як сядете за стіл. Відчуйте настрій столу, щоб під нього підлаштуватися. Знайте, хто грає тайтово, хто дико, і де гроші.',
  'hiw.handlog.title': ['Налаштуйте свій стіл.', 'Починайте запис.'],
  'hiw.handlog.body': 'Фіксуйте дії просто по ходу гри (raise, call, fold) свайпом і дотиком. Без набору тексту, без меню. Кожна роздача збережена для подальшого розбору.',
  'hiw.stats.label': 'За столом',
  'hiw.stats.title': ['Плануй наступний крок,', 'знаючи свою статистику.'],
  'hiw.stats.body': 'Дивись, як твоя статистика оновлюється наживо після кожної роздачі: PFR, агресія та інше. Помічай свої витоки й тенденції суперників просто в моменті, щоб кожне рішення спиралося на реальні цифри, а не на інтуїцію.',
  ...
  'hero.sub': 'Final Table: трекер живого покеру, створений для гри за столом. Достатньо швидкий, щоб записати роздачу однією рукою між здачами. Достатньо точний, щоб потім вивчати кожну сесію.',
  ...
  'compare.card2.desc': 'Будуйте профілі на основі статистики для кожного гравця, з яким граєте. Знайте їхню агресію та схильності, перш ніж діяти.',
  ...
  'buckle.ranges.title': 'Ranges',
  'buckle.ranges.desc': 'Будуй та вивчай ranges рук для будь-якої ситуації. Візуалізуй, які руки ти граєш, порівнюй свої рішення з ranges, схваленими солвером, і усувай ліки у своїй грі.',
  ...
  'live.reads.desc': 'Будуйте профілі на основі статистики для кожного гравця, з яким граєте. Вивчайте їхню агресію та схильності, перш ніж сісти за стіл, щоб прийти підготовленим.',
  ...
  'blogTeaser.eyebrow': 'З блогу',
  'blogTeaser.title': 'Історії, стратегія та нотатки про продукт.',
  'blogTeaser.viewAll': 'Усі статті',
  'blogTeaser.read': 'Читати',
  'blogTeaser.minRead': (p) => `${p.n} хв читання`,
  'blogTeaser.tag.strategy': 'Стратегія',
  'blogTeaser.tag.product': 'Продукт',
  'blogTeaser.tag.news': 'Новини',
  ...
  'cta.body': 'Забронюйте свій постійний нікнейм ще до запуску. Нікнейми надаються за принципом «хто перший, той і встиг». Щойно його зайняли, він зайнятий.',
  ...
  'faq.2.a': 'Нікнейми надаються за принципом «хто перший, той і встиг». Якщо ваш обраний зайнятий, спробуйте варіацію: підкреслення та цифри дозволені.',
  ...
  'about.missionP5': 'Final Table створений для кожного живого гравця, який колись завершував сесію, знаючи, що зіграв щось неправильно, але не міг пригадати що саме. Кожна роздача розповідає історію. Ми просто дбаємо про те, щоб ви її не втратили.',
  'about.value1Title': 'Спочатку швидкість',
  'about.value1Desc': 'Якщо це сповільнює вас за столом, воно не варте створення. Кожна функція розроблена працювати за секунди, а не за хвилини.',
...
const ro = {
  ...
  'hiw.body': 'Analizează profilurile adversarilor și istoricul mâinilor înainte să te așezi la masă. Simte atmosfera ca să te adaptezi la masa ta. Află cine e tight, cine e imprevizibil și unde se află banii.',
  'hiw.handlog.title': ['Pregătește-ți masa.', 'Începe înregistrarea.'],
  'hiw.handlog.body': 'Surprinde acțiunea pe măsură ce se întâmplă (raise, call, fold) cu o glisare și o atingere. Fără tastare, fără meniuri. Fiecare mână salvată pentru analiză ulterioară.',
  'hiw.stats.label': 'La masă',
  'hiw.stats.title': ['Planifică-ți următoarea mutare,', 'cunoscându-ți statisticile.'],
  'hiw.stats.body': 'Vezi cum statisticile tale se actualizează live după fiecare mână: PFR, agresivitate și altele. Descoperă-ți scurgerile și tendințele adversarilor pe loc, astfel încât fiecare decizie să se bazeze pe cifre reale, nu pe intuiție.',
  ...
  'compare.card2.desc': 'Construiește profiluri bazate pe statistici pentru fiecare jucător pe care îl întâlnești. Află agresivitatea și tendințele lor înainte să acționezi.',
  ...
  'buckle.ranges.title': 'Ranges',
  'buckle.ranges.desc': 'Construiește și studiază ranges de mâini pentru fiecare situație. Vizualizează mâinile pe care le joci, compară-ți deciziile cu ranges aprobate de solver și elimină leak-urile din jocul tău.',
  ...
  'live.reads.desc': 'Construiește profiluri bazate pe statistici pentru fiecare jucător pe care îl întâlnești. Analizează agresivitatea și tendințele lor înainte să te așezi la masă, ca să vii pregătit.',
  ...
  'footer.contactHead': 'Contact',
  'blogTeaser.eyebrow': 'De pe blog',
  'blogTeaser.title': 'Povești, strategie și note de produs.',
  'blogTeaser.viewAll': 'Vezi toate articolele',
  'blogTeaser.read': 'Citește',
  'blogTeaser.minRead': (p) => `${p.n} min de citit`,
  'blogTeaser.tag.strategy': 'Strategie',
  'blogTeaser.tag.product': 'Produs',
  'blogTeaser.tag.news': 'Știri',
  ...
  'problems.3.body': 'Final Table construiește profiluri de adversari din mâinile înregistrate, cu statistici reale și tendințe reale, ca citirile tale să fie susținute de date, nu de memorie.',
...
const sk = {
  ...
  'hiw.body': 'Prezrite si profily súperov a históriu minulých rozdaní ešte skôr, než si sadnete. Vycíťte atmosféru, aby ste sa prispôsobili svojmu stolu. Vedzte, kto hrá tesne, kto divoko a kde sú peniaze.',
  'hiw.handlog.title': ['Pripravte si stôl.', 'Začnite zaznamenávať.'],
  ...
  'hiw.stats.title': ['Naplánuj si ďalší krok,', 'so znalosťou svojich štatistík.'],
  'hiw.stats.body': 'Sleduj, ako sa tvoje štatistiky naživo aktualizujú po každom rozdaní: PFR, agresivita a ďalšie. Odhaľ svoje slabiny a sklony súperov priamo v momente, aby sa každé rozhodnutie opieralo o skutočné čísla, nie o pocit.',
  ...
  'compare.card2.desc': 'Vytvárajte štatisticky podložené profily každého hráča, proti ktorému hráte. Poznajte jeho agresivitu a tendencie ešte pred svojím ťahom.',
  ...
  'buckle.ranges.title': 'Ranges',
  'buckle.ranges.desc': 'Vytváraj a študuj ranges rúk pre každú situáciu. Vizualizuj si ruky, ktoré hráš, porovnaj svoje rozhodnutia s ranges schválenými solverom a odstráň leaky vo svojej hre.',
  ...
  'live.reads.desc': 'Vytvárajte štatisticky podložené profily každého hráča, proti ktorému hráte. Preštudujte si jeho agresivitu a tendencie ešte predtým, než si sadnete k stolu, aby ste prišli pripravení.',
  ...
  'footer.contactHead': 'Kontakt',
  'blogTeaser.eyebrow': 'Z blogu',
  'blogTeaser.title': 'Príbehy, stratégia a poznámky o produkte.',
  'blogTeaser.viewAll': 'Zobraziť všetky príspevky',
  'blogTeaser.read': 'Čítať',
  'blogTeaser.minRead': (p) => `${p.n} min čítania`,
  'blogTeaser.tag.strategy': 'Stratégia',
  'blogTeaser.tag.product': 'Produkt',
  'blogTeaser.tag.news': 'Novinky',
