...
export async function updateWaitlistUser(id, data) {
  await updateDoc(doc(db, 'waitlist', id), data)
}
...
export async function updateNicknameClaim(id, data) {
  await updateDoc(doc(db, 'nickname_claims', id), data)
}

export async function deleteNicknameClaim(id) {
  await deleteDoc(doc(db, 'nickname_claims', id))
}
...
export async function deleteSharedHand(id) {
  await deleteDoc(doc(db, 'shared_hands', id))
}
